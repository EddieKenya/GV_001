...
const Leadership = () => {
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 font-lora">
      ...
      <section className="relative bg-[#F3F3F3] py-20 border-b border-slate-200">
        <div className="container mx-auto px-6 md:px-16 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-5xl md:text-7xl font-playfair font-bold text-[#2B4D6C] mb-6 uppercase leading-tight">
              A Legacy of <br /> Transformation
            </h1>
            <p className="text-xl text-slate-700 leading-relaxed italic border-l-4 border-red-600 pl-6">
      ...
      {/* PILLAR 1: POLITICAL LEADERSHIP (MOMBASA.PNG) */}
        ...
        <div className="container mx-auto px-6 md:px-16 flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="md:w-1/2">
            <img 
              ...
              draggable="false"
              onContextMenu={disableRightClick}
              className={`w-full h-80 object-cover shadow-lg ${imageProtection}`} 
            />
          </div>
        </div>
      </section>

      {/* PILLAR 2: CABINET ROLE (MINING.PNG) */}
      ...
      {/* PILLAR 3: PRAGMATIC APPROACH (LEADERSHIP.PNG) */}
      <section className="py-24">
        <div className="container mx-auto px-6 md:px-16 flex flex-col md:flex-row gap-16 items-center">
          <div className="md:w-1/2">
      ...
      {/* PILLAR 4: VISIONARY DEVELOPMENT (UNVEILING.PNG) */}
      <section className="py-24 bg-[#2B4D6C] text-white">
        <div className="container mx-auto px-6 md:px-16 flex flex-col md:flex-row-reverse gap-16 items-center">
          <div className="md:w-1/2">
          ...
          <div className="md:w-1/2">
            <img 
              ...
              draggable="false"
              onContextMenu={disableRightClick}
              className={`w-full h-80 object-cover border-4 border-white/20 ${imageProtection}`} 
            />
          </div>
        </div>
      </section>

      {/* PILLAR 5: BACKGROUND (COUNTY.PNG) */}
      <section className="py-24">
        <div className="container mx-auto px-6 md:px-16 flex flex-col md:flex-row gap-16 items-center">
          <div className="md:w-1/2">
